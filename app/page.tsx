...
export default function Home() {
  ...
  const features = [
    {
      ...
      description:
        "Experience the warmth of heartfelt support from our AI agent, tailored to your unique needs.",
      color: "from-rose-500/20",
      delay: 0.2,
    },
    {
      icon: Lightbulb,
      title: "Insightful Insights",
      description:
        "Gain valuable insights into your mental health journey, helping you make informed decisions.",
    ...
    },
    {
      ...
      description:
        "Your interactions with our AI agent are protected by advanced encryption and privacy measures.",
  ...
  return (
    <div className="flex flex-col min-h-screen overflow-hidden">
      <section className="relative min-h-[90vh] mt-15 flex flex-col items-center justify-center py-12 px-4">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold font-pulse-jakarta tracking-tight">
            <span className="inline-block bg-gradient-to-r from-primary via-primary/90 to-secondary bg-clip-text text-transparent [text-shadow:0_1px_0_rgba(0_0_0/_20%)] hover:to-primary transition-all duration-300">
              Find Peace
            </span>
            <br />
      ...
      <section className="relative py-15 px-4 overflow-hidden">
        ...
        <motion.div className="text-center mb-16 space-y-4 text-white">
          ...
          <p className="text-foreground dark:text-foreground/95 max-w-2xl mx-auto font-medium text-lg">
            Experience the power of AI to improve your mental health and
            well-being.
          </p>
        </motion.div>
              ...
              <Card className="group relative overflow-hidden border border-primary/10 hover:border-primary/20 transition-all duration-300 h-[200px] bg-card/30 dark:bg-card/80 backdrop-blur-sm">
                ...
                <CardHeader className="pb-4">
                  <div className="flex items-center gap-3">
                    <div className="p-2 bg-primary/10 rounded-xl dark:bg-primary/20 group-hover:bg-primary/20 transition-colors duration-300">
