      ...
      <Card className="border-primary/10">
        <CardHeader>
          <CardTitle className="text-xl font-semibold flex items-center gap-2">
            <Gamepad2 className="w-5 h-5 text-primary"></Gamepad2>
            Anxitey Relief Activities
          </CardTitle>
          <CardDescription>
            {" "}
            Interactive exercises to help reduce stress and anxitey
          </CardDescription>
        </CardHeader>
                ...
                >
                  <CardContent className="p-4">
                    <div className="flex items-start gap-4">
                      ...
                      >
                        <game.icon className="h-6 w-6"></game.icon>
                      </div>
